...
const WeatherIslamabad = () => {
  ...
  const fetchForecastData = async () => {
    try {
      const response = await axios.get(`https://api.openweathermap.org/data/2.5/forecast?lat=33.7104&lon=73.1338&appid=e2988beec0b28048d0cab1ce266d13a4`);
...
export default WeatherIslamabad;
