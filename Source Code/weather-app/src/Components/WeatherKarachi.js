...
const WeatherKarachi = () => {
  ...
  const fetchWeatherData = async () => {
    try {
      const response = await axios.get(`https://api.openweathermap.org/data/2.5/weather?lat=24.9056&lon=67.0822&appid=e2988beec0b28048d0cab1ce266d13a4`);
  ...
  const fetchForecastData = async () => {
    try {
      const response = await axios.get(`https://api.openweathermap.org/data/2.5/forecast?lat=24.9056&lon=67.0822&appid=e2988beec0b28048d0cab1ce266d13a4`);
