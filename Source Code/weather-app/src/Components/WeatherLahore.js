...
const WeatherLahore = () => {
  ...
  const fetchWeatherData = async () => {
    try {
      const response = await axios.get(`https://api.openweathermap.org/data/2.5/weather?lat=31.5497&lon=74.3436&appid=e2988beec0b28048d0cab1ce266d13a4`);
  ...
  const fetchForecastData = async () => {
    try {
      const response = await axios.get(`https://api.openweathermap.org/data/2.5/forecast?lat=31.5497&lon=74.3436&appid=e2988beec0b28048d0cab1ce266d13a4`);
  ...
  return (
    ...
    <div data-aos="fade-up"> <h1 style={{ textAlign: 'center' }}>Current Weather</h1></div>
      ...
      {loading ? (
        ...
        <>
        <div data-aos="fade-up"><Card title="Weather Details">
          <div>
